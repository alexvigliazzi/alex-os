...
2. Search prior decisions (ciam_decision_context)
3. Analyze tradeoffs: performance, maintainability, scope, risk
4. Draft ADR with options
5. Plan agent decides
6. Store in memory
...
1. Identify: What test was failing?
2. Add: Specific test case for this bug
3. Add: Related edge case tests
4. Run: Full test suite
5. Verify: No new failures introduced
6. Store: Test case pattern for future
```
...
| Impact | Limit | Action if Exceeded |
|---|---|---|
| Critical | 2h | Escalate, workaround |
| High | 4h | Escalate, split |
| Medium | 1d | Backlog review |
| Low | 2d | Document, deprioritize |
